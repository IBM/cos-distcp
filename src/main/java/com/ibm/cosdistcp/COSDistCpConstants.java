 ...
 */
public class COSDistCpConstants {

  /* Default number of maps to use for COSDistCp */
  ...
  /* Boolean to indicate whether the target of COSDistCp exists. */
  public static final String CONF_LABEL_TARGET_PATH_EXISTS = "distcp.target.path.exists";
  
  /**
   * COSDistCp job id for consumers of the COSDistCp 
   */
  ...
  /**
   * Constants for COSDistCp return code to shell / consumer of ToolRunner's run
   */
  ...
  /**
   * Constants for COSDistCp default values of configurable values
   */

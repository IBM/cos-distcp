...
package com.ibm.cosdistcp.util;
...
/**
 * Utility functions used in COSDistCp.
 */
public class COSDistCpUtils {

  private static final Log LOG = LogFactory.getLog(COSDistCpUtils.class);
   ...
   * request on the file system root.  This method is used before COSDistCp job
   ...
   * on the file system root. This method is used before COSDistCp job submission
